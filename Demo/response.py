...
responses = {
            ...
            'goodbye': ['Bye! See you next time.',
                       'Ok, see ya!'],
            'default' : ['Sorry, I cannot answer your question. What I can do is to provide a description about a company or search today\'s highest, average, and lowest stock price for that company']
            }
